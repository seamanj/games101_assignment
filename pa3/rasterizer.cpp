    ...
    for(int x = bbox[0].x(); x <= bbox[1].x(); ++x)
    {
        ...
        if(insideTriangle(x, y, t.v))
        {
            ...
            if(z_interpolated < z_old)
            {
                ...
                // set_pixel(Eigen::Vector2i(x, y), 255.f * Eigen::Vector3f{1.f, 0, 0});
                ...
                Eigen::Vector3f interpolated_normal = (alpha * t.normal[0] + beta * t.normal[1] + gamma * t.normal[2]).normalized();
